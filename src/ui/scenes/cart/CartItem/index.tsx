...
const CartItem = (props: ProductInCart) => {
  ...
  const countCartItemQuantity = (
    products: typeof itemsInCart,
    id: string
  ): number => {
    let res = 0;
        ...
        return (
          <div className={classNames.attribute} key={i}>
            ...
            <span
              ...
              className={classNames.attrColor}
              key={i}
            ></span>
          </div>
        );
    ...
    <div className={classNames.cartItem}>
      ...
      <div className={classNames.imageCounterContainer}>
        ...
        <div className={classNames.counterContainer}>
          ...
          <div className={classNames.counterNumber}>
            {countCartItemQuantity(itemsInCart, shopId)}
          </div>
          <Button
            variant="secondary"
            onClick={() => dispatch(removeFromCart(shopId))}
            className={classNames.counterButton}
          >
            -
          </Button>
